...
public class LogAnalyzerTest {
	...
	@Before
	public void setUp() {
		analyzer = new LogAnalyzer();//construction
	}

	@Test
	public void fileNameWithCorrectSuffixInUppercaseIsConsideredValid() {
		boolean result = analyzer.isValidLogFileName("whatever.SLF");//command and query
	...
	public void thisTestIsBrokenAndShouldNotBeRun() throws Exception {
		throw new RuntimeException("This should never be thrownSpy");
	}
