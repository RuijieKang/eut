...
public class ExceptionWithExpectedRootCauseTest {
	@Rule
	public ExpectedException thrownSpy = ExpectedException.none();

	@Test
	public void throwsExceptionWithCorrectCause() {
		this.thrownSpy.expect(this.rootCauseOf(java.lang.IndexOutOfBoundsException.class));
		throw new RuntimeException("Ka-boom!", new IndexOutOfBoundsException());
	}
